...
function ClassDetail() {
  ...
  const openItem = async (item: Material) => {
    ...
    // Documents, pages, links — everything opens on Schoology. A student
    // API key lists a folder's contents but cannot fetch a file's bytes.
            ...
            return (
              ...
              >
                <span style={{ display: "flex", width: 18, justifyContent: "center", marginTop: 1, flexShrink: 0 }}>
                  <KindIcon kind={item.kind} tone={course.dot} />
                </span>
 ...
 *
 * The bytes would need the Schoology
